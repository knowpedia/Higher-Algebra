...
window.__etcpack__bundleSrc__['27']=function(){
  ...
  install: function install(QuickPaper) {
    // 矩阵Axy
    QuickPaper.prototype.getMatrix = function (name, x, y, flag) {
      return this.$mathFormula.matrix([[this.$mathFormula.rightBottom(name, 11), this.$mathFormula.rightBottom(name, 12), '...', this.$mathFormula.rightBottom(name, "1" + y)], [this.$mathFormula.rightBottom(name, 21), this.$mathFormula.rightBottom(name, 22), '...', this.$mathFormula.rightBottom(name, "2" + y)], ["...", "...", "", "..."], [this.$mathFormula.rightBottom(name, x + "1"), this.$mathFormula.rightBottom(name, x + "2"), '...', this.$mathFormula.rightBottom(name, x + y)]], flag);
    }; // 矩阵Axy的转置


    QuickPaper.prototype.getMatrixT = function (name, x, y) {
      return this.$mathFormula.matrix([[this.$mathFormula.rightBottom(name, 11), this.$mathFormula.rightBottom(name, 21), '...', this.$mathFormula.rightBottom(name, x + "1")], [this.$mathFormula.rightBottom(name, 12), this.$mathFormula.rightBottom(name, 22), '...', this.$mathFormula.rightBottom(name, x + "2")], ["...", "...", "", "..."], [this.$mathFormula.rightBottom(name, "1" + y), this.$mathFormula.rightBottom(name, "2" + y), '...', this.$mathFormula.rightBottom(name, x + y)]]);
    }; // 矩阵(A+B)xy


    QuickPaper.prototype.getAddMatrix = function (name1, name2, x, y) {
      return this.$mathFormula.matrix([[this.$mathFormula.join(this.$mathFormula.rightBottom(name1, 11), "+", this.$mathFormula.rightBottom(name2, 11)), this.$mathFormula.join(this.$mathFormula.rightBottom(name1, 12), "+", this.$mathFormula.rightBottom(name2, 12)), '...', this.$mathFormula.join(this.$mathFormula.rightBottom(name1, "1" + y), "+", this.$mathFormula.rightBottom(name2, "1" + y))], [this.$mathFormula.join(this.$mathFormula.rightBottom(name1, 21), "+", this.$mathFormula.rightBottom(name2, 21)), this.$mathFormula.join(this.$mathFormula.rightBottom(name1, 22), "+", this.$mathFormula.rightBottom(name2, 22)), '...', this.$mathFormula.join(this.$mathFormula.rightBottom(name1, "2" + y), "+", this.$mathFormula.rightBottom(name2, "2" + y))], ["...", "...", "", "..."], [this.$mathFormula.join(this.$mathFormula.rightBottom(name1, x + "1"), "+", this.$mathFormula.rightBottom(name2, x + "1")), this.$mathFormula.join(this.$mathFormula.rightBottom(name1, x + "2"), "+", this.$mathFormula.rightBottom(name2, x + "2")), '...', this.$mathFormula.join(this.$mathFormula.rightBottom(name1, x + y), "+", this.$mathFormula.rightBottom(name2, x + y))]]);
    }; // (aij)sn


    QuickPaper.prototype.getlittleMatrix = function (a, ij, sn) {
      return this.$mathFormula.rightBottom(this.$mathFormula.bracket(this.$mathFormula.rightBottom(a, ij), 'small'), sn);
    }; // (aij+bij)sn


    QuickPaper.prototype.getAddlittleMatrix = function (a, b, ij, sn) {
...
__etcpack__scope_args__=window.__etcpack__getBundle('40');
    ...
    script.render=function(createElement){
        ...
        return createElement('div',{"quickpaper":"","data-quickpaper-347ecaca":""},[createElement('div',{"class":"menu-view","data-quickpaper-347ecaca":""},[createElement('div',{"data-quickpaper-347ecaca":""},[createElement('a',{"href":"https://knowpedia.github.io/entry/","target":"_blank","class":"knowpedia","data-quickpaper-347ecaca":""},[]),createElement('h2',{"data-quickpaper-347ecaca":""},["《高等代数》"]),createElement('ul',{":active":"pagename==\"quantic\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"quantic\",\"top\")","data-quickpaper-347ecaca":""},["多项式"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"sy\")","data-quickpaper-347ecaca":""},["数域"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"yydxs\")","data-quickpaper-347ecaca":""},["一元多项式"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"zcdgl\")","data-quickpaper-347ecaca":""},["整除的概念"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"zdgys\")","data-quickpaper-347ecaca":""},["最大公因式"])])])])]),createElement('ul',{":active":"pagename==\"determinant\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"determinant\",\"top\")","data-quickpaper-347ecaca":""},["行列式"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"pl\")","data-quickpaper-347ecaca":""},["排列"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"njhls\")","data-quickpaper-347ecaca":""},["n级行列式"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"hlsdjs\")","data-quickpaper-347ecaca":""},["行列式的计算"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"hlsayzk\")","data-quickpaper-347ecaca":""},["行列式按一行（列）展开"])])])])]),createElement('ul',{":active":"pagename==\"linear-system-of-equations\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"linear-system-of-equations\",\"top\")","data-quickpaper-347ecaca":""},["线性方程组"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"xyf\")","data-quickpaper-347ecaca":""},["消元法"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"nwxlkj\")","data-quickpaper-347ecaca":""},["n维向量空间"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"xxxgx\")","data-quickpaper-347ecaca":""},["线性相关性"])])])])]),createElement('ul',{":active":"pagename==\"matrix\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"matrix\",\"top\")","data-quickpaper-347ecaca":""},["矩阵"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"jzdys\")","data-quickpaper-347ecaca":""},["矩阵的运算"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"jzcjdhlsyc\")","data-quickpaper-347ecaca":""},["矩阵乘积的行列式与秩"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"jzdn\")","data-quickpaper-347ecaca":""},["矩阵的逆"])])])])]),createElement('ul',{":active":"pagename==\"quadratic-form\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"quadratic-form\",\"top\")","data-quickpaper-347ecaca":""},["二次型"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"ecxjqjzbs\")","data-quickpaper-347ecaca":""},["二次型及其矩阵表示"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"bzx\")","data-quickpaper-347ecaca":""},["标准型"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"wyx\")","data-quickpaper-347ecaca":""},["唯一性"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"zdecx\")","data-quickpaper-347ecaca":""},["正定二次型"])])])])]),createElement('ul',{":active":"pagename==\"linear-space\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"linear-space\",\"top\")","data-quickpaper-347ecaca":""},["线性空间"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"jhys\")","data-quickpaper-347ecaca":""},["集合 · 映射"])]),createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"xxkjddyyjdxz\")","data-quickpaper-347ecaca":""},["线性空间的定义与简单性质"])])])])]),createElement('ul',{":active":"pagename==\"linear-transformation\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"linear-transformation\",\"top\")","data-quickpaper-347ecaca":""},["线性变换"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"xxbhddy\")","data-quickpaper-347ecaca":""},["线性变换的定义"])])])])]),createElement('ul',{":active":"pagename==\"euclidean-space\"?\"yes\":\"no\"","data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h3',{"@click":"openPage(\"euclidean-space\",\"top\")","data-quickpaper-347ecaca":""},["欧几里得空间"]),createElement('ul',{"data-quickpaper-347ecaca":""},[createElement('li',{"data-quickpaper-347ecaca":""},[createElement('h4',{"@click":"doScroll(\"dyyjbxz\")","data-quickpaper-347ecaca":""},["定义与基本性质"])])])])]),createElement('a',{"href":"https://github.com/knowpedia/Higher-Algebra","target":"_blank","data-quickpaper-347ecaca":""},["Fork Me On Github"])])]),createElement('div',{"class":"content","data-quickpaper-347ecaca":""},[createElement('div',{"id":"root-view","data-quickpaper-347ecaca":""},[createElement('component',{":is":"page","data-quickpaper-347ecaca":""},[])])])])
...
var fixedScroll =__etcpack__scope_args__.default;
    ...
    let pages = {
        quantic: () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle1.js','32'),
        determinant: () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle2.js','33'),
        "linear-system-of-equations": () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle3.js','34'),
        matrix: () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle4.js','35'),
        "quadratic-form": () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle5.js','36'),
        "linear-space": () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle6.js','37'),
        "linear-transformation": () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle7.js','38'),
        "euclidean-space": () => window.__etcpack__getLazyBundle('./build/main@v0.3.2-bundle8.js','39')
    };
